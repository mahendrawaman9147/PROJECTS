...
void man(char *name)
{
    ...
    {
        printf("Descriptor : Used to close opened fie\n");
...
void CreateDIBL()
{
    ...
    printf("DIBL created succesfully\n");
}
...
void ls_file()
{
    ...
    printf("\nFile Name \tInode numbar \tFile size\tLink count\n");
    printf("----------------------------------------------------------\n");
    while(temp != NULL)
    {
        if(temp -> FileType != 0)
...
int fstat_file(int fd)
{
    ...
    if(temp->permission == 1)
        ...
        printf("File pemission : Read & Write\n");
    printf("------------------------------------------------\n\n");
